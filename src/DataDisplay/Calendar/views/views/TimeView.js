...
export default class TimeView extends React.Component {
			...
			<div className="rdtTime">
				<table className={"w-full text-center"}>
					...
					<tbody>
						<tr>
							<td>
								<div className="rdtCounters flex flex-row items-center justify-center">
									{ items }
								</div>
							</td>
						</tr>
	...
	renderCounter( type, value ) {
		...
		return (
			<div key={ type } className="rdtCounter mx-1 flex flex-col items-center">
				<span className="rdtBtn cursor-pointer hover:bg-gray-200 hover:dark:bg-gray-700 px-1 rounded-lg select-none" onMouseDown={ e => this.onStartClicking( e, 'increase', type)}>▲</span>
				<div className="rdtCount px-1">{ value }</div>
				<span className="rdtBtn cursor-pointer hover:bg-gray-200 hover:dark:bg-gray-700 px-1 rounded-lg select-none" onMouseDown={ e => this.onStartClicking( e, 'decrease', type)}>▼</span>
			</div>
		);
	}
	...
	renderHeader() {
		...
		return (
			<div className={"w-full"}>
				<div>
					<div className="rdtSwitch hover:bg-gray-100 hover:dark:bg-gray-700 cursor-pointer "  onClick={ () => this.props.showView('days') }>
