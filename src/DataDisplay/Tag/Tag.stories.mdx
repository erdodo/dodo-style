...
<div style={{display:"flex",flexDirection:"row",alignItems:"center",flexWrap:"wrap"}}>
    <div style={{margin:"5px"}}>
        <Tag classList={"bg-gradient-to-r from-success-400 to-info-500 hover:from-pink-500 hover:to-warning-500 transition ease-in-out delay-150 duration-300 transform hover:-transecondary-y-1 hover:scale-110"} >Örnek Yazı</Tag>
    </div>
</div>
