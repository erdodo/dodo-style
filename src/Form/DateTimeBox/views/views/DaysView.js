...
export default class DaysView extends React.Component {
	...
	renderDay( date, startOfMonth, endOfMonth ) {
		...
		if ( selectedDate && date.isSame( selectedDate, 'day' ) ) {
			className += ' rdtActive hover:bg-blue-400 bg-blue-500 dark:bg-blue-500/50 dark:hover:bg-blue-400/60 text-white dark:text-white rounded-full';
		}
		if ( date.isSame( this.props.moment(), 'day' ) ) {
			className += ' rdtToday  text-blue-500 dark:text-blue-500';
		}
