...
function Docs(_ref) {
  var name = _ref.name;
  var Icons = require('dodo-icons/' + name + '/index.js');
  var _React$useState = _react.default.useState(Icons),
    _React$useState2 = _slicedToArray(_React$useState, 2),
    allIcons = _React$useState2[0],
    setAllIcons = _React$useState2[1];
  var _React$useState3 = _react.default.useState(Icons),
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("div", {
    ...
    className: "mr-3 w-full px-4 py-2 border border-gray-400 rounded-lg outline-0 focus-within:outline-0 "
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      className: "w-[120px] p-3 !m-3 flex flex-col items-center justify-center border border-gray-200 rounded-lg shadow-lg hover:shadow-xl cursor-pointer dialog",
      onClick: function onClick() {
        setDialog(true);
        setSelectedIcon(key);
        setKopyalandi(false);
    ...
    className: "bg-white shadow-lg border rounded-lg shadow-gray-400 p-4 dialog"
